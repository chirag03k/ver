...
# Choose the dataset
# airport_data, city_data
dataset = 'airport_data' 

os.system('./quickstart_bugs/clean.sh')
os.system(f'./quickstart_bugs/data_setup.sh {dataset}')
...
example_columns = [
    ...
    # city_data
    # ExampleColumn(attr='city', examples=['Chicago', 'New York']),
    # ExampleColumn(attr='Total Population', examples=['682545', '77737'])
    # ExampleColumn(attr='NO2', examples=['11', '9'])

]

"""The below code is a copy paste of ver_quick_start.py.
All variables edited to recreate the errors are above this line. 
"""
